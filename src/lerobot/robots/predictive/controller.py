...
Lifted from scripts/proto_decoupled_teleop.py + the amplitude-gated
cross-correlation patch (commit 7a1e92c61), with the stateful-lp velocity
estimator added in the dict-mode-shake fix. Extracted from
