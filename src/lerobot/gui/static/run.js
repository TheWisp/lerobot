...
function _debugVisionOptgroup() {
    return '<optgroup label="Representation models (built-in)">'
        ...
        + '<option value="sam3_tracker" data-policy-type="debug_vision">SAM3 tracker — geometric click/point segment (gated)</option>'
...
async function startObsStreamViewer() {
    ...
    if (urdfVizActive) {
        ...
        iframe.src = `/static/urdf_viz.html?v=6${ghostInit}`;
