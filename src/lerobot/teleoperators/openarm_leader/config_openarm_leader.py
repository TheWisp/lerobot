...
class OpenArmLeaderConfigBase:
    ...
    # Rewriting the motor zero changes persistent hardware state. Keep it an
    # explicit commissioning operation rather than a side effect of connect.
    set_zero_on_connect: bool = False
