...
``right_``. A bimanual robot turns them into joint commands by installing
a per-arm Cartesian-IK transform via :meth:`set_action_transform` from its
``attach_teleop`` (see ``BiSO107Follower.attach_teleop``).
"""
