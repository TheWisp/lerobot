...
class QuestVRTeleopConfig(TeleoperatorConfig):
    ...
    Output action keys (end-effector deltas; a robot's attach_teleop
    installs the Cartesian-IK transform that turns them into joints):
...
class BimanualQuestVRTeleopConfig(TeleoperatorConfig):
    ...
    attach_teleop installs the Cartesian-IK transform):
