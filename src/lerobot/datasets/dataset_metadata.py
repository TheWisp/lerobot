...
class LeRobotDatasetMetadata:
    ...
    def _load_metadata(self):
        ...
        # fork: None for datasets without a subtask lookup table, which is most
        # of them. Consumers (GUI feature editor, set_feature_values) treat None
        # as "no subtasks" rather than an error.
    ...
    def create(
        ...
        obj.tasks = None
        obj.subtasks = None  # fork: populated lazily once subtask edits are saved
        obj.episodes = None
        obj.stats = None
