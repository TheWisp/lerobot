...
class EmbEnc(nn.Module):
    """z -> e bottleneck, input-norm baked in as buffers. Structure must match sp_train_e."""

    def __init__(self, D=64):
        super().__init__()
        self.register_buffer("zmu", torch.zeros(1408))
        self.register_buffer("zsd", torch.ones(1408))
